...
func TestCommander_New(t *testing.T) {
	...
	for _, tt := range successTests {
		t.Run(tt.name, func(t *testing.T) {
			...
			grpcMock.EXPECT().Create(
				mock.AnythingOfType("*context.timerCtx"),
				mock.AnythingOfType("*model.Package")).
				Return(&id, nil)

			handler := packaging.NewCommander(&tgbotapi.BotAPI{}, service.NewPackageService(grpcMock))
	...
	for _, tt := range failTests {
		t.Run(tt.name, func(t *testing.T) {
			...
			grpcMock.AssertNotCalled(t, "Create",
				mock.AnythingOfType("*context.timerCtx"),
				mock.AnythingOfType("*model.Package"))
...
func TestCommander_Get(t *testing.T) {
	...
	for _, tt := range failTests {
		t.Run(tt.name, func(t *testing.T) {
			...
			grpcMock.AssertNotCalled(t, "Get",
				mock.AnythingOfType("*context.timerCtx"),
				mock.AnythingOfType("uint64"))
...
func TestCommander_Edit(t *testing.T) {
	...
	for _, tt := range failTests {
		t.Run(tt.name, func(t *testing.T) {
			...
			grpcMock.AssertNotCalled(t, "Update",
				mock.AnythingOfType("*context.timerCtx"),
				mock.AnythingOfType("*model.Package"))
